...
--
-- Host: localhost:3306
-- Generation Time: Jul 25, 2025 at 04:05 PM
...
--
-- Table structure for table `artifact_materials`
--
...
--
-- Dumping data for table `artifact_materials`
--
...
(2, 'The Hunts'),
(3, 'The Hunt Collection'),
(4, 'Irish Contemporary Ceramics Collection');
...
--
-- Indexes for table `artifact_categories`
--
...
--
-- Indexes for table `artifact_materials`
--
...
--
-- Constraints for table `artifact_categories`
--
ALTER TABLE `artifact_categories`
...
--
-- Constraints for table `artifact_materials`
--
ALTER TABLE `artifact_materials`
