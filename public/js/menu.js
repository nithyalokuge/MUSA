// Script for creating a circular overlay menu that expands from the center of the hamburger menu icon and collapses back into it when closed
...
function getHamburgerCenterPercent() {
  ...
  if (width >= 1600) {
    return { xPercent: 74, yPercent: 3 };
  } else if (width >= 1440) {
    return { xPercent: 93, yPercent: 7 };
  } else if (width >= 1200) {
    return { xPercent: 92, yPercent: 10 };
  } else {
