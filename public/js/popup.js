...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const memberInfo = {
    ...
    Nithya: {
      img: '/img/Nithya.png',
      blurb: 'Hi, I\'m Nithya!<br><br>As the full-stack developer for the MUSA website, I built the platform from the ground up, using both front-end and back-end technologies. I also collaborated closely with our designer, Lucy, to create an experience that\'s both functional and visually engaging. When I\'m not coding, you\'ll probably find me reading a good book.'
    },
    Kiera: {
      img: '/img/Kiera.jpg',
